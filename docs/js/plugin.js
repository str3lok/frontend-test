(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage = $("<div class='progress-percentage'><img src='images/preloader.png' alt='#'></div>");
    ...
    function insertText(scope) {
        ...
        var percentValue = Math.round(global_settings.percent)
        $(".progress-percentage").css({
            '-webkit-transform':'translate('+percentValue+'%,-'+percentValue+'%)',
            '-o-transform':'translate('+percentValue+'%,-'+percentValue+'%)',
            '-moz-transform':'translate('+percentValue+'%,-'+percentValue+'%)',
            'transform':'translate('+percentValue+'%,-'+percentValue+'%)',
        });       
    }
    // create canvas
